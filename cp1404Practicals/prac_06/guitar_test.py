...
def main():
    ...
    print("{} is vintage: expected True. got {}".format(gibson.name, gibson.is_vintage()))
    print("{} is vintage: expected False. got {}".format(another_guitar.name, another_guitar.is_vintage()))
